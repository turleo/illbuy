...
pub fn failing_constraint_test() {
  ...
  let user_request = pb.RegisterUserRequest("hey", "hi")
  let encoded_user_request = pb.encode_register_user_request(user_request)
  let request =
...
pub fn register_and_login_test() {
  ...
  let register_request = pb.RegisterUserRequest(email, "hiHIhi1@")
  let encoded_register_request =
    pb.encode_register_user_request(register_request)
