...
export const encodeErrors: Record<string, number> = {
  WrongPassword: 0,
  WrongToken: 1,
  ConstrainFailed: 2,
};

export const decodeErrors: Record<number, Errors> = {
...
function _decodeUserRequest(bb: ByteBuffer): UserRequest {
  const message: UserRequest = {} as any;
...
export function encodeRefreshTokenRequest(
...
function _encodeRefreshTokenRequest(
  message: RefreshTokenRequest,
  bb: ByteBuffer,
): void {
...
export function decodeRefreshTokenRequest(
  binary: Uint8Array,
): RefreshTokenRequest {
...
function _decodeRefreshTokenRequest(bb: ByteBuffer): RefreshTokenRequest {
  const message: RefreshTokenRequest = {} as any;
...
function _decodeTokenResponse(bb: ByteBuffer): TokenResponse {
  const message: TokenResponse = {} as any;
